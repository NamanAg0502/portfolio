export const projects = [
  ...
  },
  {
    ...
    title: 'Cryptofarm',
    description:
      'Cryptofarm is a non-custodial DEX aims at reducing MEV using batch trades and RFQ to provide fair pricing to users.',
    img: '/images/crypto.png',
    link: 'https://www.cryptofarm.fi/',
    label: 'cryptofarm.fi',
  },
  {
    id: 4,
...
export const experience = [
  {
    id: 1,
    company: 'Sozo Finance',
    title: 'Full Stack Developer',
    location: 'Berlin, Germany',
    description:
      'Sozo Finance is a non-custodial DEX aims at reducing MEV using batch trades and RFQ to provide fair pricing to users.',
